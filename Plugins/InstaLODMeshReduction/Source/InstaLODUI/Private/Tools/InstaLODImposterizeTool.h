...
enum class EInstaLODImposterizeType : uint8
{
	...
	InstaLOD_Vista						UMETA(DisplayName = "Vista")
};
...
public:
	...
	/** The position of the imposter plane respective to the AABB of the selected objects. If the value is 0 the plane will be created on the closest point to the camera. If the value is 1.0 it will be created on the farthest point. */
	UPROPERTY(Config, EditAnywhere, meta = (DisplayName = "Plane Distance", ClampMin = 0.0f, ClampMax = 1.0f), Category = "Vista Settings")
	float VistaDistance = 1.0f;

	/** If enabled, the imposter plane will be created parallel to the camera. Otherwise the imposter will be aligned to the camera.*/
	UPROPERTY(Config, EditAnywhere, meta = (DisplayName = "Parallel Imposter"), Category = "Vista Settings")
	...
	UPROPERTY(Config, EditAnywhere, meta = (DisplayName = "Cloud Normal", UIMin = -1.0f, UIMax = 1.0f, ClampMin = -1.0f, ClampMax = 1.0f), Category = "Hybrid Billboard Cloud Settings")
	...
	UPROPERTY(Config, EditAnywhere, meta = (DisplayName = "Cloud Normal Conformity", UIMin = 0.0f, UIMax = 1.0f, ClampMin = 0.0f, ClampMax = 1.0f), Category = "Hybrid Billboard Cloud Settings")
	...
	/** Enable AlphaCutOut */
	UPROPERTY(Config, EditAnywhere, meta = (DisplayName = "Enable"), Category = "Alpha Cutout")
	bool bIsAlphaCutOutEnabled = false;

	/** Enable Subdivision */
	UPROPERTY(Config, EditAnywhere, meta = (DisplayName = "Subdivide"), Category = "Alpha Cutout")
	bool bIsAlphaCutOutSubdivideEnabled = false;

	/** Resolution for Subdivision */
	UPROPERTY(Config, EditAnywhere, meta = (DisplayName = "Resolution", ClampMin = 1, ClampMax = 64), Category = "Alpha Cutout")
	...
	InstaLOD::IInstaLODMesh* TargetMesh;
	InstaLOD::IImposterizeOperation* Operation;
	InstaLOD::IInstaLODMesh* AuxMesh;
	InstaLOD::ImposterizeResult OperationResult;
	FTransform VistaTransform;
...
public:
	...
	bool IsVistaImposter() const {
		return GetType() == EInstaLODImposterizeType::InstaLOD_Vista;
	}
...
protected:
	...
	/** Called on executing vista imposter. */
	void OnVistaImposter();
