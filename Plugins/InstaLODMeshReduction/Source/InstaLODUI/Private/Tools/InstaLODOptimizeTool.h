...
UENUM()
enum class EInstaLODOptimizeType : uint8
{
	/* Represents the Percentage Triangles option in the UI */
	InstaLOD_PercentTriangles = 0		UMETA(DisplayName = "PercentTriangles"),
	/* Represents the Absolute Triangles option in the UI */
	InstaLOD_AbsoluteTriangles = 1		UMETA(DisplayName = "AbsoluteTriangles"),
	/* Represents the Screen Size In Pixels option in the UI */
...
public:
	...
	UPROPERTY(Config, EditAnywhere, meta = (EditCondition = "AutomaticQuality == EInstaLODImportance::InstaLOD_OFF", EditConditionHides, DisplayName = "Absolute Triangles", ClampMin = 0, RadioButton), Category = "Settings")
	int32 AbsoluteTriangles = 0;

	/** The target screen size for the optimization in pixels. */
	UPROPERTY(Config, EditAnywhere, meta = (EditCondition = "AutomaticQuality == EInstaLODImportance::InstaLOD_OFF", EditConditionHides, DisplayName = "Screen Size In Pixels", ClampMin = 1, ClampMax = 2048, RadioButton), Category = "Settings")
...
private:
	...
	UPROPERTY(Config)
	EInstaLODOptimizeType SettingsCheckBox = EInstaLODOptimizeType::InstaLOD_PercentTriangles;
...
public:
	...
	/** Returns current Optimize type from the selected Check Box. */
	EInstaLODOptimizeType GetActiveSetting() const {
		return SettingsCheckBox;
	}

	/** Sets the current Optimize type settings. */
	void SetActiveSetting(EInstaLODOptimizeType NewType, bool bForceSave = true);
