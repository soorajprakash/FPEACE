...
public:
	...
	*/
	 ...
	 */
	static bool FinalizeScriptProcessResult(UObject* const Entry, IInstaLOD* const InstaLODInterface, TSharedPtr<FInstaLODMeshComponent>& MeshComponent, InstaLOD::IInstaLODMesh* const OutputMesh, class UInstaLODResultSettings* const ResultSettings, TArray<UObject*>& OutputArray, UMaterialInstanceConstant* const Material, const bool bIsFreezingTransformsForMultiSelection = false);
