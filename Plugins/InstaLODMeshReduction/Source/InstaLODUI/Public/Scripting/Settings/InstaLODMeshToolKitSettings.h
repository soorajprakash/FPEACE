...
public:
	...
	UPROPERTY(BlueprintReadWrite, Config, EditAnywhere, meta = (DisplayName = "Vertex Welding", UIMin = 0.0f, UIMax = 100.0f, ClampMin = 0.0f, ClampMax = 100.0f, RadioButton), Category = "Vertex Welding and Mesh Healing")
	...
	UPROPERTY(BlueprintReadWrite, Config, EditAnywhere, meta = (DisplayName = "Welding Normal Angle", UIMin = 0.0f, UIMax = 180.0f, ClampMin = 0.0f, ClampMax = 180.0f, RadioButton), Category = "Vertex Welding and Mesh Healing")
		float VertexWeldingNormalAngle = 80.0f;

	/** Enable to weld boundary vertices only. */
	UPROPERTY(BlueprintReadWrite, Config, EditAnywhere, meta = (DisplayName = "Weld Boundaries"), Category = "Vertex Welding and Mesh Healing")
	...
	UPROPERTY(BlueprintReadWrite, Config, EditAnywhere, meta = (DisplayName = "T-Junction Healing", UIMin = 0.0f, UIMax = 10.0f, ClampMin = 0.0f, ClampMax = 10.0f, RadioButton), Category = "Vertex Welding and Mesh Healing")
	...
	UPROPERTY(BlueprintReadWrite, Config, EditAnywhere, meta = (DisplayName = "Remove Degenerate Faces", UIMin = 0.0f, UIMax = 1.0f, ClampMin = 0.0f, ClampMax = 1.0f), Category = "Vertex Welding and Mesh Healing")
		float RemoveDegenerateFaces = 0.0f;

	/** Rebuilds the mesh topology to be manifold. */
	UPROPERTY(BlueprintReadWrite, Config, EditAnywhere, meta = (DisplayName = "Fix Non Manifold"), Category = "Vertex Welding and Mesh Healing")
		bool bFixNonManifold = false;

	/** Unifies the direction of the wedge normals. */
	UPROPERTY(BlueprintReadWrite, Config, EditAnywhere, meta = (DisplayName = "Conform Normals"), Category = "Normal Recalculation")
		bool bConformNormals = false;

	/** Unifies the polygon winding order. */
	UPROPERTY(BlueprintReadWrite, Config, EditAnywhere, meta = (DisplayName = "Conform Winding Order"), Category = "Normal Recalculation")
		bool bConformWindingOrder = false;

	/** Flips the normals of the mesh. */
	UPROPERTY(BlueprintReadWrite, Config, EditAnywhere, meta = (DisplayName = "Flip Normals"), Category = "Normal Recalculation")
		bool bFlipNormals = false;

	/** Flips the winding order of the mesh. */
	UPROPERTY(BlueprintReadWrite, Config, EditAnywhere, meta = (DisplayName = "Flip Winding Order"), Category = "Normal Recalculation")
		bool bFlipWindingOrder = false;

	/** Fill all holes in the mesh. */
	UPROPERTY(BlueprintReadWrite, Config, EditAnywhere, meta = (DisplayName = "Fill Holes"), Category = "Vertex Welding and Mesh Healing")
		bool bFillHoles = false;

	/** Invalid normals can automatically be fixed by InstaLOD without recomputing all normals. */
	UPROPERTY(BlueprintReadWrite, Config, EditAnywhere, meta = (DisplayName = "Normal Healing Mode"), Category = "Normal Recalculation")
	...
	UPROPERTY(BlueprintReadWrite, Config, EditAnywhere, meta = (DisplayName = "Hard Angle Threshold", EditCondition = "bRecalculateNormals", UIMin = 0.0f, UIMax = 180.0f, ClampMin = 0.0f, ClampMax = 180.0f, RadioButton), Category = "Normal Recalculation")
		float HardangleThreshold = 80.0f;

	/** When recalculating normals: smoothed normals are weighted by various geometric properties. */
	UPROPERTY(BlueprintReadWrite, Config, EditAnywhere, meta = (DisplayName = "Weighted Normals", EditCondition = "bRecalculateNormals"), Category = "Normal Recalculation")
		bool bWeightedNormals = true;

	/** If set to a value > 0, automatically remove all submeshes (determined by adjacency) where the bounding sphere radius is below the threshold. */
	UPROPERTY(BlueprintReadWrite, Config, EditAnywhere, meta = (DisplayName = "Minimum Radius", UIMin = 0.0f, ClampMin = 0.0f), Category = "Mesh Filtering")
		float MinimumRadius = 0.0f;

	/** If set to a value > 0, automatically remove all faces with an area smaller than the specified value. */
	UPROPERTY(BlueprintReadWrite, Config, EditAnywhere, meta = (DisplayName = "Minimum Face Area", UIMin = 0.0f, ClampMin = 0.0f), Category = "Mesh Filtering")
	...
	UPROPERTY(BlueprintReadWrite, Config, EditAnywhere, meta = (DisplayName = "Deterministic Execution"), Category = "Advanced")
