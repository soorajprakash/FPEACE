...
public: 
	...
	UPROPERTY(BlueprintReadWrite, Config, EditAnywhere, meta = (EditCondition = "AutomaticQuality == EInstaLODImportance::InstaLOD_OFF", EditConditionhides, DisplayName = "Absolute Triangles", ClampMin = 0, RadioButton), Category = "Settings")
