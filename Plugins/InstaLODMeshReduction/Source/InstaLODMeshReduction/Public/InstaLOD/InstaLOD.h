...
public:
	...
	virtual void ProxyLOD(const TArray<struct FInstancedMeshMergeData>& InData, const struct FMeshProxySettings& InProxySettings,
						const TArray<struct FFlattenMaterial>& InputMaterials, const FGuid InJobGUID) override;
		
	void ProxyLODCombined(const TArray<struct FInstancedMeshMergeData>* const InDataInstanceData, const TArray<struct FMeshMergeData>* const InDataMergeData, const struct FMeshProxySettings& InProxySettings, const TArray<struct FFlattenMaterial>& InputMaterials, const FGuid InJobGUID);
